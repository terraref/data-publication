...
Although this release focuses on two seasons of data, all raw data and metadata is available in the public domain. 
Some derived products from the entire project is available for use. We will not put this in the public domain until it has been processed and validated - please contact the authors for more information.
...
table caption: "*RIL = Recombinant Inbred Lines, BAP = Bioenergy Association Panel, SAP = Sorghum Association Panel, Uniformity Trial = same lines planted in strips across field. In season 9 a second field 'North' was added, and separate trials were conducted."
