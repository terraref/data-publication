...
library(lubridate)
library(tidyr)
#s4_raw <- fromJSON('../metadata/weather/envlog_aggregated/season_4_envlog.json', 
#                   flatten = FALSE)
...
#s6_raw <- fromJSON('../metadata/weather/envlog_aggregated/season_6_envlog.json', 
#                   flatten = FALSE)
...
weather_long <- weather %>%  group_by(season, date, name) %>% 
  tally()
