...
1. Sensor Data: remote thermal, light, and shape sensors scanning a 4000 m^2^ field at approximately 1 mm^2^ resolution at hourly to weekly intervals. Additional details in the [section on sensors](#field-scanner-sensors) and sensor technical descriptions that can be found in the `metadata/sensors/` directory of this repository.
