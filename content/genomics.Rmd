...
For user convenience, we also provide this information as in a format that follows the Breeder's API (BrAPI) specification v1.3 @Selby2019 in files named `season_[n]_germplasm.json` as well as in the `terraref_sorghum_bap_samples.txt` table alongside raw sequencing data (described below).
